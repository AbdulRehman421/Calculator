    ...
    return (
        <section class="container mx-auto px-6 p-10 text-center">
            ...
            <div class="items-center mb-20">
                <h4 class="text-3xl text-blue-500 font-bold mb-3">Vision</h4>
            ...
            <div class=" flex-wrap mb-20">
                ...
                <h4 class="text-3xl text-blue-500 font-bold mb-3">Mission</h4>
                <p class="text-gray-900 mb-8">
            ...
            <div class=" text-center b-20">
                <h4 class="text-3xl text-blue-500 font-bold mb-3"> Activities </h4>
                <p class="text-gray-900 mb-8">
